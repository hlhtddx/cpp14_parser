...
user_defined_integer_literal:
    integer_literal ud_suffix
    ;

user_defined_floating_literal:
    floating_literal ud_suffix
    ;
...
lambda_declarator:
    '(' parameter_declaration_clause ')' MUTABLE_opt exception_specification_opt attribute_specifier_seq_opt trailing_return_type_opt
...
pseudo_destructor_name:
    nested_name_specifier_opt type_name CLCL '~' type_name
...
new_expression:
    CLCL_opt NEW new_placement_opt new_type_id new_initializer_opt
...
new_declarator:
    ptr_operator new_declarator_opt noptr_new_declarator
    ;
...
noptr_new_declarator:
    '[' expression ']' attribute_specifier_seq_opt
...
labeled_statement:
    attribute_specifier_seq_opt IDENTIFIER ':' statement
...
alias_declaration:
    USING IDENTIFIER attribute_specifier_seq_opt '=' type_id ';'
    ;
...
trailing_type_specifier_seq:
    trailing_type_specifier attribute_specifier_seq_opt
...
elaborated_type_specifier:
    class_key attribute_specifier_seq_opt nested_name_specifier_opt IDENTIFIER
...
enum_specifier:
    enum_head '{' enumerator_list_opt '}'
    enum_head '{' enumerator_list ',' '}'
    ;

enum_head:
    enum_key attribute_specifier_seq_opt IDENTIFIER_opt enum_base_opt
    enum_key attribute_specifier_seq_opt nested_name_specifier IDENTIFIER
    enum_base_opt
    ;

opaque_enum_declaration:
    enum_key attribute_specifier_seq_opt IDENTIFIER enum_base_opt ';'
    ;
...
original_namespace_definition:
    INLINE_opt NAMESPACE IDENTIFIER '{' namespace_body '}'
    ;

extension_namespace_definition:
    INLINE_opt NAMESPACE original_namespace_name '{' namespace_body '}'
    ;

unnamed_namespace_definition:
    INLINE_opt NAMESPACE '{' namespace_body '}'
    ;
...
qualified_namespace_specifier:
    nested_name_specifier_opt namespace_name
    ;
...
using_directive:
    attribute_specifier_seq_opt USING NAMESPACE nested_name_specifier_opt namespace_name ';'
    ;
...
attribute_specifier_seq:
    attribute_specifier_seq_opt attribute_specifier
    ;
...
parameters_and_qualifiers:
    '(' parameter_declaration_clause ')' cv_qualifier_seq_opt ref_qualifier_opt exception_specification_opt attribute_specifier_seq_opt
    ;

trailing_return_type:
    ARROW trailing_type_specifier_seq abstract_declarator_opt
    ;
...
ptr_operator:
    '*' attribute_specifier_seq_opt cv_qualifier_seq_opt
    | '&' attribute_specifier_seq_opt
...
noptr_abstract_declarator:
    noptr_abstract_declarator_opt parameters_and_qualifiers
...
function_body:
    ctor_initializer_opt compound_statement
    | function_try_block
    | '=' DEFAULT ';'
    | '=' DELETE ';'
    ;
...
initializer_list:
    initializer_clause ELLIPSIS_opt
...
member_declaration:
    attribute_specifier_seq_opt decl_specifier_seq_opt member_declarator_list_opt ';'
    | function_definition
    | using_declaration
    | static_assert_declaration
    | template_declaration
...
base_specifier_list:
    base_specifier ELLIPSIS_opt
    | base_specifier_list ',' base_specifier ELLIPSIS_opt
    ;

base_specifier:
    attribute_specifier_seq_opt base_type_specifier
...
type_parameter:
    CLASS ELLIPSIS_opt IDENTIFIER_opt
...
simple_template_id:
    template_name '<' template_argument_list_opt '>'
    ;
...
template_argument_list:
    template_argument ELLIPSIS_opt
...
function_try_block:
    TRY ctor_initializer_opt compound_statement handler_seq
    ;
